...
#### **Semantic Reasoning Agent** (e.g., Semem)
...
8. Solution Validation (Against Model)
     ↓
9. Synthesis & Ranking (Coordinator)
     ↓
10. Explanation Generation (NL Agent)
     ↓
Response to User
```
...
- Semem agent: Identifies interaction constraints from medical ontologies
...
- Semem agent: Defines capacity, timing, and regulatory constraints
...
- Semem agent: Defines regulatory and risk constraints
